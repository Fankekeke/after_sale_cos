<template>
  <a-modal v-model="show" title="维修详情" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="repairData !== null">
      <div style="text-align: center">
        <a-icon type="smile" theme="twoTone" style="font-size: 70px"/>
        <br/>
        <br/>
        <span style="font-size: 25px">预计维修时间</span>
        <b style="font-size: 18px" v-if="reserveInfo !== null">{{ reserveInfo.reserveDate }}</b>
      </div>
