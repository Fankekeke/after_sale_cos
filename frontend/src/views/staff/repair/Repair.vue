    ...
    <div>
      ...
      <a-table ref="TableInfo"
        ...
        <template slot="operation" slot-scope="text, record">
          ...
          <a-icon type="carry-out" @click="repairAuditOpen(record)" title="修 改" style="margin-left: 15px" v-if="record.repairStatus != 3 && record.repairStatus != 4"></a-icon>
        </template>
      </a-table>
    </div>
    <repair-view
...
import RepairAudit from './RepairAudit'
moment.locale('zh-cn')

export default {
  name: 'repair',
  components: {RepairView, RangeDate, RepairAudit},
  data () {
    return {
      advanced: false,
      repairAdd: {
